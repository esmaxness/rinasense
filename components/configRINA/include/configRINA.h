...
#define ESP_WIFI_SSID "WiFiTerminet" //"irati"     // //"WS02"
#define ESP_WIFI_PASS "20TrmnT22"    //"irati2017" //    //"Esdla2025"

/*********** NORMAL CONFIGURATION ****************/

#define NORMAL_PROCESS_NAME "st2.slice1" // "ue1.mobile"
#define NORMAL_PROCESS_INSTANCE "1"
#define NORMAL_ENTITY_NAME ""
#define NORMAL_ENTITY_INSTANCE ""

#define NORMAL_DIF_NAME "slice1.DIF" //" mobile.DIF" //

/*********** NORMAL IPCP CONFIGURATION ****************/
/**** Known IPCProcess Address *****/
#define LOCAL_ADDRESS (2)
#define LOCAL_ADDRESS_AP_INSTANCE "1"
#define LOCAL_ADDRESS_AP_NAME "st2.slice1" //"ue1.mobile" //"st1.slice1"

#define REMOTE_ADDRESS (11) // 11
#define REMOTE_ADDRESS_AP_INSTANCE "1"
#define REMOTE_ADDRESS_AP_NAME "gw1.slice1" // ar1.mobile //edge1.slice1
