...
#define IPCP_TASK_STACK_SIZE_WORDS (configMINIMAL_STACK_SIZE * 16)
...
#define FLOW_DEFAULT_RECEIVE_BLOCK_TIME (100 / portTICK_PERIOD_MS) /* 10 ms*/
#define FLOW_DEFAULT_SEND_BLOCK_TIME (100 / portTICK_PERIOD_MS)	   /* 10 ms*/
